...
public:
    ...
    Elem oddOrEven();             // checks if the length of list is odd or even
    void reverseAlt();
    void traverseAlt();
...
void printChoices()
{
    ...
    cout << "11 : Check if length is odd or even\n";
    cout << "12 : Exit\n";
}
...
int main()
{
    ...
    while (1)
    {
        ...
        case 10:
            ...
            break;
        case 11:
            cout << "List has " << dl.oddOrEven() << " number of elements\n";
            break;
        case 12:
            cout << "Exiting\n";
            exit(1);
